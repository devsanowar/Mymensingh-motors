...
@section('website_content')
    ...
    <div class="slider_wrapper">
        <div class="slider-active owl-carousel">
            <!--Single Slide-->
            <div class="single__slider bg-opacity" style="background-image:url({{ asset('frontend') }}/assets/img/slide/1.jpg)">
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="slider_layer_image">
                                <img src="{{ asset('frontend') }}/assets/img/slide/layer_img_1.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
